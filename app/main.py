...
from app.index_progress import mark_complete, mark_error, progress_callback, reset, snapshot
    ...
    try:
        ...
        if not archive_path.is_dir():
            ...
            raise FileNotFoundError(
                ...
                f"Archive directory not found: {archive_path}"
...
def create_app() -> Flask:
    ...
    def inject_globals() -> dict:
        ...
        if request.endpoint == "type_feed":
            ...
            active_type = request.view_args.get("post_type") if request.view_args else None
    ...
    def _render_post_cards(posts: list[PostMeta]) -> str:
        ...
        return "".join(
            ...
            render_template("post_card.html", post=post) for post in posts
    ...
    def archive_index() -> str:
        ...
        years = [
            ...
            (year, sum(archive[year].values()))

            for year in sorted_years(archive)
